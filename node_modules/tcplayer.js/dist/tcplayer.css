...
.vjs-pdt-time-display {
  margin-left: 10px; }

.vjs-live .vjs-time-divider, .vjs-live-dvr .vjs-time-divider {
  display: none; }
...
.vjs-live .vjs-playback-rate, .vjs-live-dvr .vjs-playback-rate {
  display: none; }
...
.video-js .vjs-audio-button .vjs-icon-placeholder:before {
  content: "";
  background: url(https://tcplayer-1306264703.cos.ap-nanjing.myqcloud.com/assets/audioTrack.png);
  background-size: contain;
  width: 23px;
  height: 15px;
  top: 10px;
